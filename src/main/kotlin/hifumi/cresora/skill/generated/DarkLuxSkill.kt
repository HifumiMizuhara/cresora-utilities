    ...
    ; run execute@ {
      if (hifumi.cresora.WeaponStackSupport.getDefinition(player.mainHandStack)?.id != "dark_lux")
          return@execute;
                      ...
                      if (hifumi.cresora.WeaponSkillService.hasMark(target, "entanglement"))
          return@execute;

                      hifumi.cresora.WeaponSkillService.applyMark(target, "dark", 200L); // 10s
          ...
          net.minecraft.entity.LivingEntity).damage(world, world.damageSources.magic(), it.maxHealth
          * 0.2f) };
                              }
