...
public object StridebytheLakesideSkill : WeaponSkillHandler {
  override fun activate(
    ...
    ; run execute@ {
      ...
      val ratio = hifumi.cresora.weapon.WeaponCombatSupport.currentHpTrueDamageRatio(definition,
          data)
      ...
      for (target in targets) {
                              if (!hifumi.cresora.story.StoryService.allowsTrueDamage(target))
              continue;
              ...
              hifumi.cresora.adventurerank.AdventureRankService.refreshMobDisplay(target);
                          ...
                          player.sendMessage(
                              net.minecraft.text.Text.translatable(
                                  ...
                                  hitCount,
                                  hifumi.cresora.weapon.WeaponSkillService.formatNumber(totalDamage
              / 2.0)
