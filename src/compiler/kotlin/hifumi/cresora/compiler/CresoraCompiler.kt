...
class CresoraCompiler(
    ...
    private fun FileSpec.Builder.addDefaultImports(): FileSpec.Builder {
        return this
            ...
            .addImport("net.minecraft.entity", "EntityType")
            .addImport("net.minecraft.entity", "SpawnReason")
            .addImport("net.minecraft.entity.mob", "HostileEntity")
            .addImport("net.minecraft.entity.player", "PlayerEntity")
            .addImport("net.minecraft.entity.attribute", "EntityAttributes")
            ...
            .addImport("hifumi.cresora.weapon", "WeaponStackSupport")
            .addImport("hifumi.cresora.story", "StoryService")
            .addImport("hifumi.cresora.combat", "CombatFeedbackService")
            .addImport("hifumi.cresora.combat", "BaaMimicService")
